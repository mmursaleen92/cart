...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>Login Or SignUp <span>To Shopping Cart</span></h1>
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="handler/login_handler.php" method="post" autocomplete="on"> 
                                <h1>Log in</h1> 
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form  action="handler/signup_handler.php" method="post" autocomplete="on"> 
                                <h1> Sign up </h1> 
                                <p> 
